...
var keys$1 = keys2;
var map$1 = _curry2(_dispatchable(["fantasy-land/map", "map"], _xmap$1, function map(fn, functor) {
...
var paths$1 = paths;
var path$1 = _curry2(function path(pathAr, obj) {
...
var filter$1 = _curry2(_dispatchable(["filter"], _xfilter$1, function(pred, filterable) {
...
function _toString(x2, seen) {
  ...
  switch (Object.prototype.toString.call(x2)) {
    ...
    case "[object Array]":
      return "[" + _map(recur, x2).concat(mapPairs(x2, reject$1(function(k) {
        return /^\d+$/.test(k);
      }, keys$1(x2)))).join(", ") + "]";
    case "[object Boolean]":
    ...
    default:
      ...
      return "{" + mapPairs(x2, keys$1(x2)).join(", ") + "}";
  }
}
...
var mapKeys = (fn, data2) => zipObj$1(map$2(fn, keys$1(data2)), values$1(data2));
var kebabize = (str) => {
...
function line(x$1, y$1) {
  var defined = constant$2(true), context = null, curve = curveLinear, output = null;
...
function area(x0, y0, y1) {
  var x1 = null, defined = constant$2(true), context = null, curve = curveLinear, output = null;
...
function pie() {
  var value = identity$1, sortValues = descending, sort = null, startAngle = constant$2(0), endAngle = constant$2(tau), padAngle = constant$2(0);
  function pie2(data2) {
    var i, n = (data2 = array$1(data2)).length, j, k, sum = 0, index2 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da) / n, padAngle.apply(this, arguments)), pa = p * (da < 0 ? -1 : 1), v;
    for (i = 0; i < n; ++i) {
  ...
  setup(props) {
    ...
    const buildArea = () => {
      ...
      if (chart.config.direction === "vertical") {
        return area().curve(lineType(props.type)).y0((p) => p.y).y1((p) => p.y).x0((p) => p.x).x1((_) => secondary.scale(0));
      }
      return area().curve(lineType(props.type)).x0((p) => p.x).x1((p) => p.x).y0((p) => p.y).y1((_) => secondary.scale(0));
    };
  ...
  return openBlock(), createBlock(_component_Layer, {
    ...
    default: withCtx(() => [
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.bars, (bar, i) => {
        return openBlock(), createElementBlock("rect", mergeProps({ class: "chart-bar" }, _ctx.toKebabCase(_ctx.getStyle(__spreadProps(__spreadValues({}, bar.props), { active: i === _ctx.mouse.index }))), {
          key: i,
          x: bar.x,
          y: bar.y,
      ...
      _ctx.selectedBar ? (openBlock(), createElementBlock("rect", mergeProps({
        key: 1,
        class: "chart-bar"
      }, _ctx.toKebabCase(_ctx.getStyleSelected(__spreadValues({}, _ctx.selectedBar.props))), {
  ...
  return openBlock(), createBlock(_component_Layer, {
    ...
    default: withCtx(() => [
      ...
      createBaseVNode("g", { transform: _ctx.transform }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.arcs, (arc2, i) => {
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.data.length ? (openBlock(), createElementBlock("g", {
    ...
    !_ctx.hideX ? (openBlock(), createElementBlock("g", _hoisted_2$3, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.xLines, (y2, i) => {
    ...
    !_ctx.hideY ? (openBlock(), createElementBlock("g", _hoisted_4$2, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.yLines, (x2, i) => {
        return openBlock(), createElementBlock("line", {
          key: i,
          x1: x2,
          y1: _ctx.canvas.y,
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.show ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.items, (item, i) => {
            return openBlock(), createElementBlock("div", {
              ...
              createTextVNode(": " + toDisplayString(item.valueFormatted), 1)
            ], 4);
          }), 128))
        ], 4)
      ])
    ...
    !_ctx.hideLine ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
      _ctx.direction === "horizontal" ? (openBlock(), createElementBlock("div", {
        key: 0,
...
function stratify() {
  ...
  function stratify2(data2) {
    ...
    if (path3 != null) {
      const I = nodes.map((d2, i2) => normalize(path3(d2, i2, data2)));
  ...
  stratify2.path = function(x2) {
    return arguments.length ? (path3 = optional(x2), stratify2) : path3;
  };
  return stratify2;
}
          ...
          return openBlock(), createElementBlock("g", {
            ...
            renderSlot(_ctx.$slots, "default", {
              ...
              renderSlot(_ctx.$slots, "text", {
                ...
                createBaseVNode("text", _hoisted_6, toDisplayString(r.data.name), 1)
              ])
            ])
          ], 42, _hoisted_4);
        }), 128))
...
export {
  ...
  script$4 as Tooltip,
  script$1 as Treemap,
  vue3_charts_default as default,
  useBars,
  useChart,
  useMouse,
  usePoints,
