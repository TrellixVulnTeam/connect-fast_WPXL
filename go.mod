...
require (
	...
	github.com/tse-lao/ipfs-user v0.0.1
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.36 => /Users/koenschuite/go/pkg/mod/github.com/wailsapp/wails/v2@v2.0.0-beta.36
